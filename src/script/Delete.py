...
def delete():
    #calls functions delete from other program.
    validate = ValidateUser.delete(conn, cursor)
    validate.deleteUser()

if __name__ == '__main__':
    delete()
The next set of code is for made for the teacher GUI, this contains one python module named ‘teacher.py’
from tkinter import *
import psycopg2
import platform
